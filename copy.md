...
2kw diesel heater / excellent active ventilation

The van is fully insulated with high thermal grade materials - celetex under the floor, a synthetic flexible material on the walls and threaded into the beams behind an air gap and a thermal reflective barrier. A 2kw diesel heater with full controls (timer, thermostat etc) then works to keep the van toasty even in sub zero temperatures. Water and gas are internal so the van works fine in the snow. Conversely in the summer the same insulation ensures the van doesn't get too hot and the Maxair fan pulls from the smaller, insect meshed, window positioned just above the bed to create strong, cooling airflow on high settings, or remove condensation set very low. We've camped from -5 degrees to 38 degrees in comfort.
...
Deadbolts on the doors plus safe

Every door has an independent dead bolt alongside the normal central locking and concealed in the bottom cupboard is a floor mounted safe, this can be opened with a key but also with a code or a fingerprint! Perfect for cash, passports, spare keys etc. when exploring.

## Storage

There's a large locker over the cab, cupboards under and above the kitchen and through the living area. Under the main seat in both front and back are large storage areas and there's dry and wet storage (wetsuits etc) in the back under the bed. A huge rhino roof rack means altogether you can take way more than you need with you on any trip. The second bed makes an excellent surfboard rack if travelling as a couple.
